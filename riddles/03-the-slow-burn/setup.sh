...
if ! state_done "opencode-configured"; then
    step "Configure OpenCode (MCP + skills)" "$RIDDLE_DIR/../common/setup-opencode.sh"
...
echo "Check the lab lesson tab for guidance."
echo ""
...
echo "  kubectl get pods -n riddle-3 -w           # Watch pod status"
echo "  kubectl describe pod <pod> -n riddle-3    # Check termination details"
